            ...
            <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-3 py-2.5 px-4 border border-gray-300 rounded-xl shadow-sm text-sm font-bold text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 transition-all"
                    >
