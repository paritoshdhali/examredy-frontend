            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16 items-center">
                    <div className="flex-shrink-0 flex items-center">
                        <Link to="/" className="text-2xl font-bold text-primary">ExamRedy</Link>
                    </div>

                    <div className="hidden md:flex space-x-8">
                        <Link to="/" className="text-gray-700 hover:text-primary transition">Home</Link>
                        <Link to="/practice" className="text-gray-700 hover:text-primary transition">Practice</Link>
                        <Link to="/group" className="text-gray-700 hover:text-primary transition">Group Mode</Link>
                        <Link to="/prime" className="text-amber-500 font-semibold hover:text-amber-600 transition">Prime</Link>
                    </div>
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        {user ? (
                            <div className="flex items-center space-x-4">
                                ...
                                {user.role === 'admin' && (
                                    <Link to="/admin" className="text-sm text-indigo-600 font-medium">Dashboard</Link>
                                )}
